...
(function () {
  ...
  const MICHAEL_COMPANIES = [
    ...
    { id: 'northwind-ops', name: 'Amazing Pet Store', level: 'L2', depth: 1, parent: 'northwind-group' },
  ...
  function michaelActiveCompany() {
    return MICHAEL_COMPANIES.find((company) => company.id === michaelCompanySelection) || MICHAEL_COMPANIES[1];
  }
